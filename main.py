...
######################################################################
#Chemin d'acces de ma page de connection
@app.route('/')
def login():
    if 'ERROR' in session:
        msg = session['ERROR']
...
######################################################################
#Chemin d'acces de ma page d'enregistrement
@app.route('/register')
def about():
    if 'ERROR' in session:
...
######################################################################
#Chemin d'acces de ma page d'acceuil
@app.route('/home')
def home():
    ...
    if 'user_id' in session:
        ...
        return redirect('/')
######################################################################
#Chemin d'acces de ma page collection
...
def collection():
    if 'user_id' in session:
        ...
        return render_template('index.html')
######################################################################
#Chemin d'acces lorsque l'on s'enregistre
@app.route('/login_validation', methods=['POST'])
#Fonction pour verifier la connection
...
def add_user():
    ...
    try:
        ...
        return redirect('/register')
######################################################################
#Chemin d'acces pour le bouton deconection
@app.route('/logout')
def logout():
    session.pop('user_id')
    return redirect('/')
